    ...
    editor.addButton('mfnsc', {
      ...
      menu: [{
        ...
        },
        {
          text: 'Custom Image',
          onclick: function() {
            editor.insertContent('[custom_image src="" size="" width="" height="" align="" stretch="0" border="0" margin_top="" margin_bottom="" link_image="" link="" target="" hover="" alt="" caption="" greyscale="" animate=""]');
          }
        },
         {
          text: 'Image',
